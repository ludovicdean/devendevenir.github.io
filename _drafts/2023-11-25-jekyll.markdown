...
Un projet Jekyll est constitué de plusieurs packages aux rôles distincts :
...
On peut voir juste ici le contenu du fichier layouts/layout.html du thème minima.
