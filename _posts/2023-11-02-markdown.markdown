...
categories: Documentation, outils
...
image: "https://github.com/ludovicdean/devendevenir.github.io/tree/main/images/markdown.png"
---

&nbsp;

!["Bannière de l'article avec le logo de Markdown"](/images/markdown-logo.png)

# Markdown, la documentation as code
...
```
![Texte alternatif de l'image](/images/markdown-image.jpg)
```
...
```
[![Texte alternatif de l'image](/images/markdown-image.jpg)](https:www.google.fr)
```
